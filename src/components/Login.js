...
const toggleSignInForm=()=>{
  ...
  return (
    ...
    <form onSubmit={(e) => e.preventDefault()}
      ...
      <input ref={password} type='password' placeholder='Password' className='p-4 mb-6 my-4 w-full bg-gray-800'/>
      ...
      <p className='cursor-pointer underline' onClick={toggleSignInForm}>{isSignInForm ? "New to Netflix? Sign Up Now" : "Already Registered? Sign In Now"}</p>
    </form>  
